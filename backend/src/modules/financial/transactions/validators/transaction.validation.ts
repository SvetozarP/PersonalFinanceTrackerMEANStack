...
export const baseTransactionSchema = Joi.object({
    ...
    .messages({
        ...
        'any.only': 'Transaction type must be one of: income, expense, transfer, adjustment',
    }),
    ...
    location: Joi.object({
      ...
      .messages({
        'any.required': 'Original amount is required when original currency is provided',
      ...
      .optional()
      .trim()
      .pattern(currencyPattern, 'Original currency must be a valid 3-letter ISO code')
      .uppercase()
      .allow(''),
      ...
      .messages({
        'any.required': 'Exchange rate is required when original currency is provided',
      ...
      .messages({
        'any.required': 'Recurrence interval is required when transaction is recurring',
      ...
      .messages({
        'any.required': 'Recurrence end date is required when transaction is recurring',
      ...
      .messages({
        'any.required': 'Next occurrence date is required when transaction is recurring',
